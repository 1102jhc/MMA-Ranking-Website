...
<body>
 ...
 <form action="membershipDB.jsp" method="get">
 <table align="center">
...
<tr><td><font color="white">NAME</font></td><td><input type="text" name="name" class="info"></td></tr>
<tr><td><font color="white">ADDRESS</font></td><td><input type="text" name="addr" class="info"></td></tr>
<tr><td><font color="white">PHONE-NUMBER</font></td><td><input type="text" name="tel" class="info"></td></tr>
