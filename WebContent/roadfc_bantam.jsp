...
<body>
<div align="center">
	<a href = "ROADFC.jsp?target=roadfc_heavy">Heavy</a>
	<a href = "ROADFC.jsp?target=roadfc_light">Light</a>
	<a href = "ROADFC.jsp?target=roadfc_bantam">Bantam</a>
...
<table>
    ...
    <%
        ...
        try{
            ...
            String sql = "SELECT * FROM roadfc_player where weight = 'bantam' order by Ranking ";
